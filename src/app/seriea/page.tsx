    ...
    useEffect(() => {
        const fetchTeams = async () => {
            try {
                ...
                const teamsQuery = query(teamsCollection, where("League", "==", "Serie A"));
        ...
        <div className="flex h-screen bg-[#151716] justify-center items-center text-sm">
            <div className="flex flex-col justify-center text-center w-[75%]">
                <h1 className="flex justify-center items-center bg-[#232323] w-full text-lg font-bold p-4">
                    Serie A<img src="/Serie A.png" className="w-[30px] h-[30px] m-2" />
                </h1>
                <h2 className="flex justify-center items-left text-base font-semibold bg-[#232323] w-full">Italy</h2>
