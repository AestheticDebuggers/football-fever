...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-[#212121] p-6 md:px-[100px]">

      <div className="flex gap-6">
        <div className="flex items-center flex-shrink-0 text-white mr-6">
          <span className="font-semibold  tracking-tight font-salsa text-2xl">Football Fever</span>
        </div>

        <div className="flex rounded-full bg-[#333333] min-w-[200px] ">
          ...
          <input
            type="text"
            className="w-[250px] bg-transparent pl-2 text-base font-semibold outline-0"
            placeholder="Search"
            id=""
          />
        </div>
