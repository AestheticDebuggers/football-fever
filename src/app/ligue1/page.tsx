    ...
    useEffect(() => {
        const fetchTeams = async () => {
            try {
                ...
                const teamsQuery = query(teamsCollection, where("League", "==", "Ligue 1"));
        ...
        <div className="flex h-screen bg-[#151716] justify-center items-center text-sm">
            <div className="flex flex-col justify-center text-center w-[75%]">
                <h1 className="flex justify-center items-center bg-[#232323] w-full text-lg font-bold p-4">
                    Ligue 1<img src="/Ligue 1.png" className="w-[30px] h-[30px] m-2" />
                </h1>
                <h2 className="flex justify-center items-left text-base font-semibold bg-[#232323] w-full">France</h2>
